    ...
    <main>
        ...
        <div className="c_about_us_container">
            ...
            <div className="c_about_us c_about_us_A">
                ...
                <div>
                    ...
                    <h2 data-aos="fade-up" data-aos-offset="300" data-aos-easing="ease-in-sine">
                    ...
                    <div className="c_contact_action c_contact_action_B">
                        ...
                        <div className="c_contact_actionB_container">
                            ...
                            <div className="c_contact_action_container" id="norms">
                                ...
                                <div className="c_contact_action_B_container" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
                            ...
                            <div className="c_contact_action_container" id="norms">
                                ...
                                <div className="c_contact_action_B_container" data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine">
        ...
        <div className="c_about_us_container">
            ...
            <div className="c_about_us c_about_us_B">
                ...
                <div className="c_about_us_B_container" data-aos="fade-up" data-aos-offset="300" data-aos-easing="ease-in-sine">
        ...
        <div className="c_about_us_container">
            <div className="c_about_what_we_do" data-aos="fade-up" data-aos-offset="300" data-aos-easing="ease-in-sine">
        ...
        <div className="c_find_doctor">
            ...
            <div className="c_find_doctor_container">
                ...
                <div className="c_find_a_doctor_icon_container">
                <FontAwesomeIcon icon={faNotesMedical} className="c_find_a_doctor_icon"/>
        ...
        <div className="c_about_us_container">
            ...
            <div className="c_appoinment_bmi_container" data-aos="fade-right">
            ...
            <div className="c_about_us_container" data-aos="fade-left">

                <div className="c_appoinment_bmi_container">

                    <div  className="c_appoinment_bmi c_appoinment_container">

                    <h3><b>H</b>ealth <b>C</b>enters <b>C</b>onsulting <b>F</b>or:</h3>
